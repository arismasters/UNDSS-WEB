<div class="">
    <div class="uk-padding-small uk-inline">
        ...
        <div id="my-id" class="uk-width-1-3@l uk-width-1-1@s uk-background-secondary uk-position-right p-5 uk-height-viewport text-white">
            <div class="">
                <button class="uk-offcanvas-close" type="button" uk-toggle="target: #my-id" uk-close></button>
